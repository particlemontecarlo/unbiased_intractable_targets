...
## with the std deviation of the proposal used in the paper by Heng et al.
...
nmcmc <- 250000
# save file
savef <- paste0("pmmh.csmc.originalsd.T", nmcmc, ".N", nparticles, ".niter", niter, ".RData")
